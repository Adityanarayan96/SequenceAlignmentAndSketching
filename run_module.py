...
DATASETS = 'gc0.2  gc0.2_sub1.68_ins8.04_del3.16  gc0.2_del3.16  gc0.2_ins8.04  gc0.2_ins8.04_del3.16  gc0.2_sub1.68  nctc1080  unif  gc0.2_sub25  gc0.2_sub50'
...
n_bits = 24
n_hash = 100
OUT_DIR = join(PROJ_DIR, 'out', '5-9-sh-2')
METHOD = suffix_hash
args = {'est_method':2}  # estimation method 1: num front matching bases, 2: edit distance
#####################################
